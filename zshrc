...
alias sduo='sudo'
alias ema='open -a emacs'
alias r='ranger'
alias cls='clear && ls'
alias e="emacsclient -nw"
alias mux='ssh -i ~/.ssh/shwsun-cs/id_rsa shwsun@csa2.bu.edu -t tmux a'
#alias ="g++ test.cpp && ./a.out"
alias myserver='ssh -p 2222 ubuntu@localhost'
alias javac="javac -J-Dfile.encoding=utf8"
alias grep="grep --color=auto"
alias -s html=mate   # 在命令行直接输入后缀为 html 的文件名，会在 sublime 中打开
alias -s rb=mvim     # 在命令行直接输入 ruby 文件，会在 sublime中打开
alias -s py=mvim    # 在命令行直接输入 python 文件，会用 emacs 中打开，以下类似
alias -s js=mate
alias -s c=mvim
alias -s java=mvim
alias -s txt=mvim
...
alias GIT='git add --all . && git commit -m "`curl -s http://whatthecommit.com/index.txt`" &&  git push '
alias shwsun='ssh -i ~/.ssh/shwsun-cs/id_rsa shwsun@csa2.bu.edu'
alias shwsun3='ssh -i ~/.ssh/shwsun-cs/id_rsa shwsun@csa3.bu.edu'
alias ls='ls -F --color=auto'
alias ll='ls -al'
alias grep='grep --color=auto'
alias la='ls -a'
alias vim='e'
alias draft="vim ~/.draft.md"
alias lc='echo "LeetCode\n 10 min + 20 min " && cd ~/code/leetcode/MySol'
alias rm='rmtrash'
alias imissu= 'cat I know this is hard, but you need to move on and fight.\n And...dont apologize, cause it is a sign of weakness.'
alias reminder='echo "HowTo:\n + prove that I am smart or dedicated?\n   Rule #6"'
alias rules='cat ~/code/rules.md'
...
export PATH="/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:${PATSHOME}/bin"
...
#路径别名 {{{
#进入相应的路径时只要 cd ~xxx
#hash -d coding="/Users/arch/code/coding"
hash -d training="/Users/arch/training"
hash -d bu="/Users/arch/Desktop/BostonUniversity/"
hash -d 330="/Users/arch/Desktop/BostonUniversity/schedule/330"
hash -d 655="/Users/arch/Desktop/BostonUniversity/schedule/655"
hash -d 520="/Users/arch/Desktop/BostonUniversity/schedule/520"
#hash -d work="/Users/arch/code/cs520-2015-fall-shwsun_/Assignment/" 
hash -d todo="/Users/arch/Desktop/BostonUniversity/schedule/655/PA1" 
hash -d networking="/Users/arch/coding/networking"
hash -d stuf="/Users/arch/Public"
hash -d coding="~/coding"
...
export PATSHOME=/Users/arch/develop/MYATS/ATS2-Postiats
export PATSHOMERELOC=/Users/arch/develop/MYATS/ATS2-Postiats-contrib
#export PATSHOME_contrib=/Users/arch/Desktop/BostonUniversity/schedule/520/ats/ATS2-contrib
